    ...
    <div className="fixed top-0 left-0 w-screen h-screen z-50 bg-black/60 backdrop-blur-sm">
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[420px] sm:max-w-[600px] lg:max-w-[984px]  p-4 max-h-[90vh] overflow-auto">
        <div className="bg-white modal-text shadow-md dark:bg-[#12141d] rounded-2xl sm:grid sm:grid-cols-[2fr_1fr] overflow-hidden">
          ...
          <div className="p-5 lg:p-11 relative">
            ...
            <div className="grid lg:grid-cols-2 gap-2 absolute bottom-10">
              <a
              ...
              <a
                onClick={onClose}
                href="#"
                className="border hover:border-primary border-[#74766f] rounded-lg py-2 px-5 flex items-center gap-2 justify-center text-[#171923] font-semibold text-sm"
              >
                <button>
                  <span>Cancel</span>
                </button>
