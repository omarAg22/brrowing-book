      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[420px] sm:max-w-[600px] lg:max-w-[790px] p-4 max-h-[90vh] overflow-auto">
        <div className="bg-white shadow-md dark:bg-[#12141D] rounded-2xl overflow-hidden p-5 md:p-9">
                  ...
                  >
                    ...
                    <div className="flex justify-between gap-4 items-center">
                      <button
                        ...
                        onClick={(evt) => handleDeleteCart(evt, item)}
                      >
                        <MdDeleteOutline />
          ...
          <div className="flex items-center justify-end gap-2">
            ...
            <a
              className="border hover:border-primary border-[#74766F] rounded-lg py-2 px-5 flex items-center justify-center gap-2 text-[#6F6F6F] dark:text-gray-200 font-semibold text-sm"
              href="#"
              onClick={onClose}
            >
              Cancel
