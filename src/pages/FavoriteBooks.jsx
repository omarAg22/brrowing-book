...
const FavoriteBooks = () => {
  ...
  return (
    <div className="shadow-md dark:bg-[#12141D] rounded-2xl overflow-auto p-5 md:p-9 custom-scroll">
      <h2 className="text-2xl lg:text-[30px] mb-10 font-bold">
        Your Favorite Books
      </h2>
      <div className="space-y-8 lg:space-y-12 max-h-[450px]  mb-10 lg:mb-14">
        {state.bookmarkBooks.length === 0 ? (
          <p className="text-xl overflow-hidden">
            You haven't selected any books as favorites yet!!!
          </p>
        ) : (
          state.bookmarkBooks.map((item) => (
